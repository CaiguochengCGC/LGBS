...
import com.hanthink.yqcj.dao.PmcDatePpneckDao;
...
public class ExportPmcDatePpneckForStopTimeDayAction extends ActionImp {
    ...
    protected void doException(ActionContext atx, Exception ex) {
        atx.setErrorContext("EC_COMMON_1004", MessageService.getMessage("EC_COMMON_1004"), "按ALARM_Top查询【瓶颈设备表】", ex);
    }

    protected int performExecute(ActionContext atx) throws Exception {

        String fileName = "按报警top20导出";
        String title = "按报警top20导出";
      ...
      //获取值
        List beanList = PmcDatePpneckDao.queryPmcDatePpneckForStopTimeByPager(con, pager, startDate, endDate, timeType,yearTime);
...
//导出图片       
        ...
        logger.info("导出报警报表"+"wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww++++++++++++++++++++++++++++++++++++++++++");
