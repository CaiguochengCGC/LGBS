...
import com.hanthink.yqcj.dao.PmcDatePpDao;
import com.hanthink.pub.dao.SysParamDao;
import com.hanthink.util.ExcelUtil;
import com.hanthink.util.Tools;

public class ExportPmcDatePpAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        totalCount = PmcDatePpDao.countPmcDatePp(con, ppDate);
        ...
        String fileName = "实际生产时间报表";
        List beanList = PmcDatePpDao.queryPmcDatePp(con, ppDate);
    ...
    protected int verifyParameters(ActionContext atx) throws Exception {
        ...
        ppDate = DateUtils.parse(atx.getStringValue("WORKDATE", ""), "yyyy-MM-dd");
