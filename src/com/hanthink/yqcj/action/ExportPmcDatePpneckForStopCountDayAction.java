...
public class ExportPmcDatePpneckForStopCountDayAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        String fileName = "按停机次数查询瓶颈设备报表";
        String title = "按停机次数查询瓶颈设备报表";
        ...
        if ("0".equals(queryType)) { // 日
        	fileName = "按停机次数查询瓶颈设备日报表";
        	title = "按停机次数查询瓶颈设备日报表";
        	...
        	fileName = "按停机次数查询瓶颈设备月报表";
        	title = "按停机次数查询瓶颈设备月报表";
        	timeType = 7;
        	...
        	fileName = "按停机次数查询瓶颈设备年报表";
        	title = "按停机次数查询瓶颈设备年报表";
        	timeType = 4;
        	...
        	fileName = "按停机次数查询瓶颈设备周报表";
        	title = "按停机次数查询瓶颈设备周报表";
        ...
        //获取值
        List beanList = PmcDatePpneckDao.queryPmcDatePpneckForStopCountByPager(con, pager, startDate, endDate, timeType,yearTime).getRs();
...
//        List beanList = PmcDatePpneckDao.queryPmcDatePpneckForStopCount(con, ppdate);
...
//导出图片       
        ...
        logger.info("导出按停机次数查询瓶颈设备日报表");

        atx.setObjValue("", "按停机次数查询瓶颈设备日报表");
