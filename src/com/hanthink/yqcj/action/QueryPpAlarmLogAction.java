...
import com.hanthink.yqcj.dao.PmcAlarmLogDao;
...
public class QueryPpAlarmLogAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        ComboPager cp = PmcAlarmLogDao.queryPpAlarmLogImport(con, startEffectTime, endEffectTime, productionline, banci, data3, pager);
