...
public class ExportPmcDatePpneckForStopCountMonthAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        String fileName = "按停机次数查询瓶颈设备月报表";
        String title = "按停机次数查询瓶颈设备月报表";
        ...
        int totalCount = 0;
        totalCount = PmcDatePpneckDao.countPmcDatePpneckForStopCountMonth(con, ppdate);
        ...
        List beanList = PmcDatePpneckDao.queryPmcDatePpneckForStopCountMonth(con, ppdate);
...
//导出图片       
        ...
        logger.info("导出按停机次数查询瓶颈设备月报表");

        atx.setObjValue("", "按停机次数查询瓶颈设备月报表");
