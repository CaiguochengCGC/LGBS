 ...
 * 
 *
 * @File name:  DeletePmcViewRecordAction.java   删除【意见反馈表:YQCJ_VIEW_RECORD】
...
import com.hanthink.yqcj.po.PmcViewRecordPO;
...
public class DeletePmcViewRecordAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        logger.info("删除操作：" + atx.getStringValue("SESSION_USER_NO") + "@" + new Date(System.currentTimeMillis()) + "删除表：【意见反馈表:YQCJ_VIEW_RECORD】 主键【" + atx.getStringValue("ID")
                + "|" + "】");
        return 1;
    }
