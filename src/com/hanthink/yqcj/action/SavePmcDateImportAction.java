...
public class SavePmcDateImportAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        try {
            ...
            List excelDataList = ExcelUtil.importExcelForSpecial(filePO.getFileItem().getInputStream(), columns, 19, 3);
            ...
            for (int i = 0; i < excelDataList.size(); i++) {
                ...
                System.out.println("##############"+DateUtils.parse(String.valueOf(beanMap.get("WORKDATE")), "yyyy/MM/dd"));
            }
