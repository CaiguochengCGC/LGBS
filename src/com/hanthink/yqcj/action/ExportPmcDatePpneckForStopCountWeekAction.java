...
public class ExportPmcDatePpneckForStopCountWeekAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        String fileName = "按停机次数查询瓶颈设备周报表";
        String title = "按停机次数查询瓶颈设备周报表";
        ...
        int totalCount = 0;
        totalCount = PmcDatePpneckDao.countPmcDatePpneckForStopCountYear(con, ppdate);
        ...
        //获取值
        List beanList = PmcDatePpneckDao.queryPmcDatePpneckForStopWeekTime(con, firstOfWeek, lastOfWeek);
...
//导出图片       
        ...
        logger.info("导出按停机次数查询瓶颈设备周报表");

        atx.setObjValue("", "按停机次数查询瓶颈设备周报表");
