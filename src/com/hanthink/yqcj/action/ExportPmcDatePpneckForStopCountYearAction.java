...
public class ExportPmcDatePpneckForStopCountYearAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        String fileName = "按停机次数查询瓶颈设备年报表";
        String title = "按停机次数查询瓶颈设备年报表";
        ...
        List beanList = PmcDatePpneckDao.queryPmcDatePpneckForStopCountYear(con, ppdate);
...
//导出图片       
        ...
        logger.info("导出按停机次数查询瓶颈设备年报表");

        atx.setObjValue("", "按停机次数查询瓶颈设备年报表");
