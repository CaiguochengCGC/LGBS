...
public class ExportPmcCycleSpeedMonthAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        String fileName = "循环速度月报表";
        String title = "循环速度月报表";
...
//导出图片       
        ...
        JFreeChart freeChart = JfreeChartUtil.createPieChart(dataset, fileName, "", "循环速度月报表", fontLabel, fontxAix, colors, true);
        ...
        logger.info("导出循环速度月报表");

        atx.setObjValue("", "循环速度月报表");
