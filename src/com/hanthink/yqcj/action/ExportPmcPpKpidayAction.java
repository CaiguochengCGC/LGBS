...
//导出表格
        ...
        int totalCount = 0;
        totalCount = PmcPpKpidayDao.countPmcPpKpiday(con, ppdate);
        ...
        List beanList = PmcPpKpidayDao.queryPmcPpKpiday(con, ppdate,banci);
...
//导出图片       
        ...
        list = PmcPpKpidayDao.queryPmcPpKpiday(con, ppdate,banci);
