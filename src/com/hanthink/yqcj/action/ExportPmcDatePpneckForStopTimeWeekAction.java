...
public class ExportPmcDatePpneckForStopTimeWeekAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        String fileName = "按停机时间查询瓶颈设备周报表";
        String title = "按停机时间查询瓶颈设备 周报表";
        ...
        int totalCount = 0;
        totalCount = PmcDatePpneckDao.countPmcDatePpneckForStopTimeYear(con, ppdate);
...
//导出图片       
        ...
        logger.info("导出按停机时间查询瓶颈设备周报表");

        atx.setObjValue("", "按停机时间查询瓶颈设备周报表");
