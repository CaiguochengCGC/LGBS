...
public class QueryPmcDatePpneckForStopTimeAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        //获取值
        List list = PmcDatePpneckDao.queryPmcDatePpneckForStopTimeByPager(con, pager, startDate, endDate, timeType,yearTime);
