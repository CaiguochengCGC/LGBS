...
import com.hanthink.yqcj.dao.PmcSystemReportDao;
...
public class ExportPmcSystemReportAction extends ActionImp {
    ...
    protected void doException(ActionContext atx, Exception ex) {
        atx.setErrorContext("EC_COMMON_1004", MessageService.getMessage("EC_COMMON_1004"), "导出油漆车间总报表", ex);
    }

    protected int performExecute(ActionContext atx) throws Exception {
    	
        String fileName = "油漆车间总报表";
        String fileName1 = "油漆车间总报表柱状图";
        String title = "油漆车间总报表";
