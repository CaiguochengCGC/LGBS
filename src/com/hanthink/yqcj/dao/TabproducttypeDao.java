...
/**
 * 【YQCJ_tabProductType:tabProductType】的Dao操作类
 * 
 */
public class TabproducttypeDao extends DAO {
    /**
     * 查询所有【YQCJ_tabProductType:tabProductType】信息
     * 
     * @param con
     * @return
     * @throws Exception
    ...
    public static List queryTabproducttype(Connection con, String startDate, String endDate, java.lang.String productionLine,java.lang.String banci)
        ...
        cqexp.select("select EventData5,EventData6,avg(BANCI) AS BANCI,SUM(IP21) AS IP21,SUM(IP22) AS IP22,SUM(IP23) AS IP23,SUM(ZP11) AS ZP11,SUM(BP31) AS BP31,SUM(IP24) AS IP24,SUM(BP32) AS BP32,SUM(AS21) AS AS21,SUM(PRODUCTTOTAL) AS productTotal from YQCJ_PP_PRODUCT");
        cqexp.where();
        ...
        logger.info("油漆车间查询所有【YQCJ_tabProductType:YQCJ_tabProductType】信息：" + cqexp.getSql());
    ...
    public static int countTabproducttype(Connection con, Date startDate, Date endDate, String productionLine) throws Exception {
        ...
        cqexp.select(" from YQCJ_tabProductType ");
        ...
        logger.info("油漆车间统计【YQCJ_tabProductType:CYCJtabProductType】信息：" + cqexp.getSql());
