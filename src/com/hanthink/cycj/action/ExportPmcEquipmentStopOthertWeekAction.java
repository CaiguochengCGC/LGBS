...
public class ExportPmcEquipmentStopOthertWeekAction extends ActionImp {
    private Connection con = null;
    private Date ppdate;
    private String pdLine;

    protected void doException(ActionContext atx, Exception ex) {
        atx.setErrorContext("EC_COMMON_1004", MessageService.getMessage("EC_COMMON_1004"), "【工位设备停机周报表】", ex);
    }
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        List beanList = PmcEquipmentStopForProductionLineDao.queryPmcEquipmentStopWeek(con, firstOfWeek, lastOfWeek,pdLine);
