...
public class ExportPmcStationCtMonthAction extends ActionImp {
    private Connection con = null;
    private Date ppdate;
    private java.lang.String proline;

    protected void doException(ActionContext atx, Exception ex) {
        atx.setErrorContext("EC_COMMON_1004", MessageService.getMessage("EC_COMMON_1004"), "【工位CT月 报表】", ex);
    }
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        String fileName = "瓶颈工位查询按停机节拍月报表";
        List beanList = PmcStationCtDao.queryMonthPmcStationCt(con, ppdate,proline);
