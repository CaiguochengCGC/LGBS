...
import com.hanthink.cycj.dao.PmcEquipmentStopForProductionLineDao;
import com.hanthink.pub.dao.SysParamDao;
import com.hanthink.util.ExcelUtil;
import com.hanthink.util.Tools;

public class ExportPmcEquipmentStopOthercYearAction extends ActionImp {
    private Connection con = null;
    private Date ppdate;
    private String pdLine;

    protected void doException(ActionContext atx, Exception ex) {
        atx.setErrorContext("EC_COMMON_1004", MessageService.getMessage("EC_COMMON_1004"), "【瓶颈工位查询停机次数年报表】", ex);
    }
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        totalCount = PmcEquipmentStopForProductionLineDao.countPmcEquipmentStopCtYear(con, ppdate,pdLine);
...
*/
        ...
        String fileName = "瓶颈工位查询停机次数年报表";
        List beanList = PmcEquipmentStopForProductionLineDao.queryPmcEquipmentStopCtYear(con, ppdate,pdLine);
