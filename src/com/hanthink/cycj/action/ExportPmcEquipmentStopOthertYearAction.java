...
public class ExportPmcEquipmentStopOthertYearAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        int totalCount = 0;
        /*totalCount = PmcEquipmentStopForProductionLineDao.countPmcEquipmentStopYear(con, ppdate,pdLine);
        ...
        String fileName = "瓶颈工位查询停机时间年报表";
        List beanList = PmcEquipmentStopForProductionLineDao.queryPmcEquipmentStopYear(con, ppdate,pdLine);
