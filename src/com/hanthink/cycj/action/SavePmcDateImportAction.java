...
import com.hanthink.cycj.dao.PmcDateImportDao;
...
public class SavePmcDateImportAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        try {
            ...
            // 获取excel解析对应的列
            String[] columns = null;
            columns = new String[] { "WORKDATE", "STARTTIME", "ENDTIME", "RESTTIME", "SHIFT", "IP21", "IP22", "IP23","ZP11", "productTotal" };

            // 获取解析的数据
            //List excelDataList = ExcelUtil.importExcel(filePO.getFileItem().getInputStream(), columns, 2, 1);
            List excelDataList = ExcelUtil.importExcelForCycj(filePO.getFileItem().getInputStream(), columns,38, 3);
