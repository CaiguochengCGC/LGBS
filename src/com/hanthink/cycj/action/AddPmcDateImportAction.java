 ...
 * 
 *
 * @File name:  AddPmcDateImportAction.java   添加【CYCJ_DATE_IMPORT 计划日期数量导入:CYCJ_DATE_IMPORT】
...
public class AddPmcDateImportAction extends ActionImp {
	...
	protected void doException(ActionContext atx, Exception ex) {
		if (!(ex instanceof UserOperationException)) {
			atx.setErrorContext("EC_COMMON_1001", MessageService.getMessage("EC_COMMON_1001"),"【CYCJ_DATE_IMPORT 计划日期数量导入】", ex);
		}
	}
	@Override
