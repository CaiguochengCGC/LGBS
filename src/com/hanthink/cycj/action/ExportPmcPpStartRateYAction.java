...
import com.hanthink.cycj.dao.PmcPpStartRateDao;
import com.hanthink.cycj.dao.PmcPpStartRateYDao;
...
//导出表格    	
        ...
        int totalCount = 0;
        totalCount = PmcPpStartRateYDao.countPmcPpStartRateY(con, yyyy);
        ...
        List beanList = PmcPpStartRateYDao.queryPmcPpStartRateY(con, yyyy,banci);
...
//导出图片
        ...
        list = PmcPpStartRateYDao.queryPmcPpStartRateY(con, yyyy,banci);
