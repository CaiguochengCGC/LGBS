...
//        totalCount = PmcEquipmentStopDao.countPmcEquipmentStopWeek(con, firstOfWeek, lastOfWeek,proline);
//        List beanList = PmcEquipmentStopDao.queryWeekPmcEquipmentStop(con, firstOfWeek, lastOfWeek,proline);

        List list = PmcEquipmentStopDao.queryPmcEquipmentStopWeek(con, firstOfWeek, lastOfWeek,proline,station,equipmentstop);
        List listEq = PmcEquipmentStopDao.queryPmcEquipmentStopWeekEq(con, firstOfWeek, lastOfWeek,proline,station,equipmentstop);
