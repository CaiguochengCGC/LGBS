...
public class ExportASPMMonthAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        String fileName = "换模时间月报表";
        String title = "换模时间月报表";
...
//导出图片       
        ...
        JFreeChart freeChart = JfreeChartUtil.createPieChart(dataset, fileName, "", "换模时间月报表", fontLabel, fontxAix, colors, true);
        ...
        logger.info("导出换模时间月报表");

        atx.setObjValue("", "换模时间月报表");
