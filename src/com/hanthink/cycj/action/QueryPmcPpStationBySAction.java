...
import com.hanthink.cycj.dao.PmcPpStationDao;

public class QueryPmcPpStationBySAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        List list = PmcPpStationDao.queryPmcPpStationByS(con, codeType);
    ...
    protected int verifyParameters(ActionContext atx) throws Exception {
        ...
        codeType = atx.getStringValue("PRODUCTIONLINENAME", "").trim();
