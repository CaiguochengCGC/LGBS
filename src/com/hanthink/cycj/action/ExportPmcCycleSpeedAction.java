...
public class ExportPmcCycleSpeedAction extends ActionImp {
    ...
    protected void doException(ActionContext atx, Exception ex) {
        atx.setErrorContext("EC_COMMON_1004", MessageService.getMessage("EC_COMMON_1004"), "【循环速度日报表】", ex);
    }

    protected int performExecute(ActionContext atx) throws Exception {

        String fileName = "循环速度日报表";
        String title = "循环速度日报表";
...
//导出图片       
        ...
        String[] legendKeys = new String[] {  "循环速度(秒)" };// 图例名称
        ...
        JFreeChart freeChart = JfreeChartUtil.createPieChart(dataset, fileName, "", "循环速度日报表", fontLabel, fontxAix, colors, true);
        ...
        logger.info("导出循环速度日报表");

        atx.setObjValue("", "循环速度日报表");
