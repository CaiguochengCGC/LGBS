...
public class ExportPmcEquipmentStopOthertMonthAction extends ActionImp {
    private Connection con = null;
    private Date ppdate;
    private String pdLine;

    protected void doException(ActionContext atx, Exception ex) {
        atx.setErrorContext("EC_COMMON_1004", MessageService.getMessage("EC_COMMON_1004"), "【工位设备停机月报表】", ex);
    }
    ...
    protected int performExecute(ActionContext atx) throws Exception {
       ...
       /* totalCount = PmcEquipmentStopForProductionLineDao.countPmcEquipmentStopMonth(con, ppdate,pdLine);
        ...
        String fileName = "瓶颈工位查询停机时间月报表";
        List beanList = PmcEquipmentStopForProductionLineDao.queryPmcEquipmentStopMonth(con, ppdate,pdLine);
