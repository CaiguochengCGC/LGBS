...
public class ExportASPMYearAction extends ActionImp {
    ...
    protected void doException(ActionContext atx, Exception ex) {
        atx.setErrorContext("EC_COMMON_1004", MessageService.getMessage("EC_COMMON_1004"), "【换模时间年报表】", ex);
    }

    protected int performExecute(ActionContext atx) throws Exception {

        String fileName = "换模时间年报表";
        String title = "换模时间年报表";
...
//导出图片       
        ...
        JFreeChart freeChart = JfreeChartUtil.createPieChart(dataset, fileName, "", "换模时间年报表", fontLabel, fontxAix, colors, true);
        ...
        logger.info("导出换模时间年报表");

        atx.setObjValue("", "换模时间年报表");
