...
/**
 * 【工段停线报表:CYCJ_EQUIPMENT_STOPLINE】的Dao操作类
 * 
 */
public class PmcEquipmentStoplineDao extends DAO {
    /**
     * 查询所有【工段停线报表:CYCJ_EQUIPMENT_STOPLINE】信息
     * 
     * @param con
     * @return
     * @throws Exception
    ...
    public static List queryPmcEquipmentStopline(Connection con, Date ppdate, Date nextPpdates,String banci) throws Exception {
        ...
        cqExp.select("select PRODUCTIONLINE,PRODUCTIONLINENAME,avg(BANCI) AS BANCI,avg(CYCLETIME) AS CYCLETIME,avg(BEIZHU) AS BEIZHU, ");
        ...
        cqExp.select(" from CYCJ_EQUIPMENT_STOPLINE ");
        cqExp.where();
        ...
        logger.debug("冲压车间CYCJ_EQUIPMENT_STOPLINE查询所有【工段停线报表:CYCJ_EQUIPMENT_STOPLINE】信息:  " + cqExp.getSql());
        return cqExp.getDynaBeanMapList("CYCJ_EQUIPMENT_STOPLINE", con);
    }
    ...
    public static int countPmcEquipmentStopLine(Connection con, Date ppdate, Date nextPpdates) throws Exception {
        ...
        cqExp.orderByAsc("seq,PRODUCTIONLINENAME");
        logger.debug("冲压车间CYCJ_EQUIPMENT_STOPLINE统计所有【工段停线日报表:CYCJ_EQUIPMENT_STOPLINE】信息:  " + cqExp.getSql());
        return Integer.parseInt(String.valueOf(cqExp.getDynaBeanMap("CYCJ_EQUIPMENT_STOPLINE", con).get("TOTAL_NUM")));
    }
    ...
    public static List queryMonPmcEquipmentStopline(Connection con, Date ppdate,String banci) throws Exception {
        CQExp cqExp = CQExp.instance();
        cqExp.select("select PRODUCTIONLINE, PRODUCTIONLINENAME,avg(BANCI) AS BANCI,");
        cqExp.select("cast(avg(CYCLETIME) as decimal(18,2)) as  CYCLETIME,");
        cqExp.select("cast(avg(BEIZHU) as decimal(18,2)) as  BEIZHU,");
        cqExp.select("cast(sum(STOPTIME)/60.0 as decimal(18,2)) as  STOPTIME,");
        cqExp.select("sum(STOPCOUNT) as STOPCOUNT,");
        cqExp.select("cast(sum(DATA3)/60.0 as decimal(18,2)) as DATA3,");
        cqExp.select("cast(sum(DATA4)/60.0 as decimal(18,2)) as DATA4,");
        ...
        cqExp.filed("".equals(banci)? null : "BANCI", CQExp.EQ, banci);
        cqExp.group("seq, PRODUCTIONLINE, PRODUCTIONLINENAME");
        cqExp.orderByAsc("seq,PRODUCTIONLINENAME");
        logger.debug("冲压车间CYCJ_EQUIPMENT_STOPLINE查询所有【工段停线月报表:CYCJ_EQUIPMENT_STOPLINE】信息:  " + cqExp.getSql());
        return cqExp.getDynaBeanMapList("CYCJ_EQUIPMENT_STOPLINE", con);
    }
    ...
    public static int countPmcEquipmentStopLineMonth(Connection con, Date ppdate) throws Exception {
        ...
        cqExp.group(" seq,ID,PRODUCTIONLINENAME,FACTORY,WORKSHOP,PRODUCTIONLINE,SHIFT,OPERUSER,UPDATETIME, STOPTIME, STOPCOUNT,DATA3,DATA4,DATA5, DATA6, DATA7 ");
        cqExp.orderByAsc("seq,PRODUCTIONLINENAME");
        logger.debug("冲压车间CYCJ_EQUIPMENT_STOPLINE统计所有【工段停线月报表:CYCJ_EQUIPMENT_STOPLINE】信息:  " + cqExp.getSql());
        return Integer.parseInt(String.valueOf(cqExp.getDynaBeanMap("CYCJ_EQUIPMENT_STOPLINE", con).get("TOTAL_NUM")));
    }
    ...
    public static List queryYearPmcEquipmentStopline(Connection con, Date ppdate,String banci) throws Exception {
        ...
        cqExp.group("seq, PRODUCTIONLINE, PRODUCTIONLINENAME");
        cqExp.orderByAsc("seq,PRODUCTIONLINENAME");
        logger.debug("冲压车间CYCJ_EQUIPMENT_STOPLINE查询所有【工段停线年报表:CYCJ_EQUIPMENT_STOPLINE】信息:  " + cqExp.getSql());
        return cqExp.getDynaBeanMapList("CYCJ_EQUIPMENT_STOPLINE", con);
    }
    ...
    public static int countPmcEquipmentStopLineYear(Connection con, Date ppdate) throws Exception {
        ...
        cqExp.group("seq,ID,PRODUCTIONLINENAME,FACTORY,WORKSHOP,PRODUCTIONLINE,SHIFT,OPERUSER,UPDATETIME, STOPTIME, STOPCOUNT,DATA3,DATA4,DATA5, DATA6, DATA7 ");
        cqExp.orderByAsc("seq,PRODUCTIONLINENAME");
        logger.debug("冲压车间CYCJ_EQUIPMENT_STOPLINE统计所有【工段停线年报表:CYCJ_EQUIPMENT_STOPLINE】信息:  " + cqExp.getSql());
        return Integer.parseInt(String.valueOf(cqExp.getDynaBeanMap("CYCJ_EQUIPMENT_STOPLINE", con).get("TOTAL_NUM")));
    }
    ...
    public static List queryWeekPmcEquipmentStopline(Connection con, Date startDate,Date lastDate,String banci) throws Exception {
        ...
        cqExp.group("seq, PRODUCTIONLINE, PRODUCTIONLINENAME");
        cqExp.orderByAsc("seq,PRODUCTIONLINENAME");
        logger.debug("冲压车间CYCJ_EQUIPMENT_STOPLINE查询所有【工段停线周报表:CYCJ_EQUIPMENT_STOPLINE】信息:  " + cqExp.getSql());
        return cqExp.getDynaBeanMapList("CYCJ_EQUIPMENT_STOPLINE", con);
    }
    ...
    public static int countPmcEquipmentStopLineWeek(Connection con, Date startDate,Date lastDate) throws Exception {
        ...
        cqExp.group("seq,ID,PRODUCTIONLINENAME,FACTORY,WORKSHOP,PRODUCTIONLINE,SHIFT,OPERUSER,UPDATETIME, STOPTIME, STOPCOUNT,DATA3,DATA4,DATA5, DATA6, DATA7 ");
        cqExp.orderByAsc("seq,PRODUCTIONLINENAME");
        logger.debug("冲压车间CYCJ_EQUIPMENT_STOPLINE统计所有【工段停线周报表:CYCJ_EQUIPMENT_STOPLINE】信息:  " + cqExp.getSql());
        return Integer.parseInt(String.valueOf(cqExp.getDynaBeanMap("CYCJ_EQUIPMENT_STOPLINE", con).get("TOTAL_NUM")));
    }
    ...
    public static List queryPmcEquipmentStoplineKpi(Connection con, Date ppdate) throws Exception {
        ...
        cqExp.select(" from CYCJ_EQUIPMENT_STOPLINE A,CYCJ_DATE_PP B,CYCJ_DATE_IMPORT C");
        cqExp.where();
    ...
    public static List queryMonPmcEquipmentStoplineKpi(Connection con, Date ppdate) throws Exception {
        ...
        cqExp.orderByAsc("PRODUCTIONLINENAME");
        logger.debug("CYCJ_EQUIPMENT_STOPLINE查询所有【工段停线报表:CYCJ_EQUIPMENT_STOPLINE】信息:  " + cqExp.getSql());
        return cqExp.getDynaBeanMapList("CYCJ_EQUIPMENT_STOPLINE", con);
    }
