...
import cn.boho.framework.po.DataBean;
        ...
        /**
 * 【工位CT报表:ZZCJ_STATION_CT】
 */
public class PmcStationCtPO implements DataBean {
	...
	private java.lang.String productionlinename;//工段(线体)名称
	...
	*/
	...
	/**
	* 【工位CT报表:ZZCJ_STATION_CT】<br>
	* <u>工段(线体)名称【PRODUCTIONLINENAME】</u> : <br>
	* 
	...
	*/
	...
	public PmcStationCtPO clone() {
		PmcStationCtPO obj=new PmcStationCtPO();
		obj.setId(id);
