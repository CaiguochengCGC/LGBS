...
import com.hanthink.zzcj.dao.TabStopLineDao;
...
/*导出停线查询表*/
public class ExportTabStopLineActionCut extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        List beanList = TabStopLineDao.queryTabStopLine2(con, startPlanDate, endPlanDate,eventdate40,eventdate1,banci);
        //获取责任部门
