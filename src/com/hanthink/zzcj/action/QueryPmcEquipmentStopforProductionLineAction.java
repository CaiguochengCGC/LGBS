...
public class QueryPmcEquipmentStopforProductionLineAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        list = PmcEquipmentStopForProductionLineDao.queryPmcEquipmentStopAgen(con, startDate, endDate,banci,productionlineName);
    ...
    protected int verifyParameters(ActionContext atx) throws Exception {
        ...
        productionlineName=java.net.URLDecoder.decode(atx.getStringValue("PRODUCTIONLINENAME", "").trim(),"UTF-8");
        return 1;
    }
}
