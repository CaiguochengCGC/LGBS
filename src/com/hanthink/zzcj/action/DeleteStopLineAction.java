 ...
 * 
 *
 * @File name:  DeletePmcDateImportAction.java   删除【计划日期数量导入:ZZCJ_DATE_IMPORT】
...
import com.hanthink.zzcj.po.tabStoplinePO;
...
public class DeleteStopLineAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        logger.info("删除操作：" + atx.getStringValue("SESSION_USER_NO") + "@" + new Date(System.currentTimeMillis()) + "删除表：【计划日期数量导入:ZZCJ_DATE_IMPORT】 主键【" + atx.getStringValue("ID")
                + "|" + "】");
        return 1;
    }
