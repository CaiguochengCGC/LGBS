...
public class ExportPmcEquipmentStopMonthAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        List list = PmcEquipmentStopDao.queryPmcEquipmentStopMonth(con, ppdate,proline,station,equipmentstop);
        List listEq = PmcEquipmentStopDao.queryPmcEquipmentStopMonthEq(con, ppdate,proline,station,equipmentstop);
