...
public class ExportPmcEquipmentStopAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        String fileName = "工位设备停机日报表";
        List list = PmcEquipmentStopDao.queryPmcEquipmentStopAgen(con, ppdate,proline,station,equipmentstop);
        List listEq = PmcEquipmentStopDao.queryPmcEquipmentStopAgenEq(con, ppdate,proline,station,equipmentstop);
