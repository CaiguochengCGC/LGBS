...
import com.hanthink.util.DictConstants;
        ...
        /**
 * 【工位CT报表:PMC_STATION_CT】的Dao操作类
 * 
 */
public class PmcStationCtDao extends DAO {
	/**
	* 查询所有【工位CT报表:PMC_STATION_CT】信息
	* @param con
	* @return
	* @throws Exception
	* @date 2014-03-19
	...
	*/
	...
	public static List queryDayPmcStationCt(Connection con,Date ppdate,String productionline,String banci)throws Exception{
        ...
        cqExp.select(" from PMC_STATION_CT as a , ");
        cqExp.select(" (select PRODUCTIONLINE, MAX(DATA12) AS DATA12  FROM   PMC_STATION_CT ");
        ...
        logger.debug(" PMC_STATION_CT查询所有【工位CT报表:PMC_STATION_CT】信息:  " + cqExp.getSql());
        return cqExp.getDynaBeanMapList("PMC_STATION_CT", con);
	}
	
	public static int countDayPmcStationCt(Connection con,Date ppdate,String productionline)throws Exception{
        CQExp cqExp = CQExp.instance();
        cqExp.select("select count(*) as TOTAL_NUM from PMC_STATION_CT  ");
        cqExp.where();
        ...
        logger.debug(" PMC_STATION_CT查询所有【工位CT报表:PMC_STATION_CT】信息:  " + cqExp.getSql());
        return Integer.parseInt(String.valueOf(cqExp.getDynaBeanMap("PMC_STATION_CT", con).get("TOTAL_NUM")));
    }
	
	public static List queryMonthPmcStationCt(Connection con,Date ppdate,String productionline,String banci) throws Exception {
        CQExp cqExp = CQExp.instance();
        ...
        logger.debug(" PMC_STATION_CT查询所有【工段停线报表:PMC_STATION_CT】信息:  " + cqExp.getSql());
        return cqExp.getDynaBeanMapList("PMC_STATION_CT", con);
    }
...
//        cqExp.filed(null == ppdate ? null : "convert(varchar(20),PPDATE,23)", CQExp.EQ, DateUtils.format(ppdate, "yyyy-MM"));
	...
	public static List queryYearPmcStationCt(Connection con,Date ppdate,String productionline,String banci) throws Exception {
        CQExp cqExp = CQExp.instance();
        /*cqExp.select("select a.PRODUCTIONLINE, a.PRODUCTIONLINENAME,a.STATION,a.MODEL,a.DATA14,a.DATA4,a.DATA5,a.DATA6,a.DATA7,a.DATA8,a.DATA9,a.DATA10,a.DATA11,a.DATA12");
        cqExp.select(" from PMC_STATION_CT as a , ");
        cqExp.select(" (select PRODUCTIONLINE, MAX(DATA12) AS DATA12  FROM   PMC_STATION_CT ");
...
//        cqExp.filed(null == ppdate ? null : "convert(varchar(20),PPDATE,23)", CQExp.EQ, DateUtils.format(ppdate, "yyyy"));
	...
	public static List queryWeekPmcStationCt(Connection con, Date startDate,Date lastDate,String productionline,String banci) throws Exception {
        CQExp cqExp = CQExp.instance();
        cqExp.select("select distinct a.PRODUCTIONLINE, a.PRODUCTIONLINENAME,a.STATION,a.MODEL,a.DATA14,a.DATA4,a.DATA5,a.DATA6,a.DATA7,a.DATA8,a.DATA9,a.DATA10,a.DATA11,a.DATA12");
        cqExp.select(" from PMC_STATION_CT as a");
