...
//导出表格数据
        ...
        String[] columns = {"PRODUCTIONLINE","PRODUCTIONLINENAME","YYPLANP","YYREALP","WEEKRATE","SHIFTT","DATA1", "DATA2", "DATA3", "DATA4", "DATA5", "DATA6", "DATA7", "DATA8", "DATA9"
        ...
        String[] headers = {"工段/周","工段名字","计划产量","总产量","实际完成率","SHIFT","第1周","第2周","第3周","第4周","第5周","第6周","第7周","第8周","第9周","第10周","第11周","第12周","第13周",
        ...
        List beanList = PmcPpWeekDao.queryPmcPpWeek(con,ppdate,banci,whereSQL);
