...
import com.hanthink.pmc.dao.PmcPpMmDao;
...
public class ExportPmcPpMmAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
    	...
    	String fileName = "产量月报表";
        String fileName1 = "产量月报表折线图";
        String fileName2 = "产量月报表柱状图";
        String title = "产量月报表";
...
//导出表格数据        
        ...
        int totalCount = 0;
        totalCount = PmcPpMmDao.countPmcPpMm(con, ppdate);
        ...
        List beanList = PmcPpMmDao.queryPmcPpMm(con, ppdate,banci,whereSQL);
...
//导出图片
        ...
        String[] legendKeys = new String[] {  "计划月产量","实际月产量" };// 图例名称
        String[] dataKeys = new String[] { "MMPLANP","MMREALP" };// 数据字段名称
        ...
        HSSFClientAnchor anchor1 = new HSSFClientAnchor(beanList.size(), 15, beanList.size()+200, 15, (short) 15, beanList.size()+5, (short) 15, beanList.size()+40);
