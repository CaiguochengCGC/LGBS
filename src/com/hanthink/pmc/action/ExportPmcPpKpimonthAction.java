...
import com.hanthink.pmc.dao.PmcPpKpimonthDao;
...
public class ExportPmcPpKpimonthAction extends ActionImp {
...
//导出表格
        ...
        int totalCount = 0;
        totalCount = PmcPpKpimonthDao.countPmcPpKpimonth(con, ppdate);
        ...
        String fileName = "KPI月报表";
        List beanList = PmcPpKpimonthDao.expPmcPpKpimonth(con, ppdate,banci);
...
//导出图片       
        ...
        list = PmcPpKpimonthDao.queryPmcPpKpiMonthPic(con, ppdate,banci);

        // 创建CategoryDataset对象（准备数据）
        String[] legendKeys = new String[] {  "当月MTTR(分)","当月MTBF(分)","当月设备利用率","当月设备停机率","当月停线时间(分)","当月停线次数"};// 图例名称
        ...
        String[] colors = new String[] { "#8B1C62", "#7FFF00", "#7B68EE","#7FFF00","#CD3333","#CAFF70" };
        ...
        logger.info("导出KPI月报表");

        atx.setObjValue("", "KPI月报表");
