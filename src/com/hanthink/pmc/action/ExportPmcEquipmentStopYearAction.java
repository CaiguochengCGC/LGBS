...
public class ExportPmcEquipmentStopYearAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        List list = PmcEquipmentStopDao.queryPmcEquipmentStopYear(con, ppdate,proline,station,equipmentstop,banci,whereSQL);
        List listEq = PmcEquipmentStopDao.queryPmcEquipmentStopYearEq(con, ppdate,proline,station,equipmentstop,banci,whereSQL);
