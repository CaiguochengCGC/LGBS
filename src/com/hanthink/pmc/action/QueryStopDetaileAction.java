...
public class QueryStopDetaileAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        if("1".equals(queryTypeT)){
            ...
            List cp = TabStopLineDao.queryStopDetail1(con, startTime, endTime, lineCode, stopType,shift,whereSQL,queryTypeT);
