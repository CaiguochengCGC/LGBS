...
public class QueryPmcStationCtAction extends ActionImp {
	...
	protected int performExecute(ActionContext atx) throws Exception {
        ...
        if("0".equals(queryType)){  //日
            ...
            list = PmcStationCtDao.queryDayPmcStationCt(con, ppdate,productionline,banci);
        }else if("1".equals(queryType)){
            //月
            ppdate = DateUtils.parse(atx.getStringValue("PPDATE"),"yyyy-MM");
            list = PmcStationCtDao.queryMonthPmcStationCt(con, ppdate,productionline,banci);
        }else if("2".equals(queryType)){
            //年
            ppdate = DateUtils.parse(atx.getStringValue("PPDATE"),"yyyy");
            list = PmcStationCtDao.queryYearPmcStationCt(con, ppdate,productionline,banci);
            ...
            list = PmcStationCtDao.queryWeekPmcStationCt(con, firstOfWeek,lastOfWeek,productionline,banci);
        }
