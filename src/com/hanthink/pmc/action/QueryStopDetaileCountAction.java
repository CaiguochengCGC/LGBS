...
public class QueryStopDetaileCountAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        if("1".equals(queryTypeT)){
            ...
            List cp = TabStopLineDao.queryStopDetail1Cpunt(con, startTime, endTime, lineCode, stopType,shift,whereSQL,queryTypeT);
...
//        endTime   = DateUtils.parse(atx.getStringValue("END_TIME"), DictConstants.FORMAT_DATE);
        startTime = DateUtils.parse(atx.getStringValue("START_TIME"), DictConstants.FORMAT_DATETIME);
        endTime = DateUtils.parse(atx.getStringValue("END_TIME"), DictConstants.FORMAT_DATETIME);
