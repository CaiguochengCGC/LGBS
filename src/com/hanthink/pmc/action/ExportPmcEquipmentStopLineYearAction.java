...
public class ExportPmcEquipmentStopLineYearAction extends ActionImp {
    ...
    protected void doException(ActionContext atx, Exception ex) {
        atx.setErrorContext("EC_COMMON_1004", MessageService.getMessage("EC_COMMON_1004"), "【工段停线年报表】", ex);
    }
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        String fileName = "工段停线年报表";
        String title = "工段停线年报表";
        ...
        int totalCount = 0;
        totalCount = PmcEquipmentStoplineDao.countPmcEquipmentStopLineYear(con, ppdate);
        ...
        List beanList = PmcEquipmentStoplineDao.queryYearPmcEquipmentStopline(con, ppdate,banci,whereSQL);
...
//导出图片       
        ...
        JFreeChart freeChart = JfreeChartUtil.createPieChart(dataset, fileName, "", "工段停线年报表", fontLabel, fontxAix, colors, true);
        ...
        logger.info("导出工段停线年报表");

        atx.setObjValue("", "工段停线年报表");
