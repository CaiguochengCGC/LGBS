...
public class QueryPmcPpKpimonthAction extends ActionImp {
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        if (banci.equals("1")||banci.equals("2")) {
            List list = PmcPpKpimonthDao.queryPmcPpKpimonth(con, sdf.format(ppdate), banci,whereSQL);
            atx.setValue("PMC_PP_KPIMONTH", list.toArray());
            return 1;
        }else {
            List list = PmcPpKpimonthDao.queryPmcPpKpimonthAll(con, sdf.format(ppdate), banci,whereSQL);
            atx.setValue("PMC_PP_KPIMONTH", list.toArray());
            return 1;
        }
    }
