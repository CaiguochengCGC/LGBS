...
public class ExportPmcEquipmentStopMonthAction extends ActionImp {
    ...
    protected void doException(ActionContext atx, Exception ex) {
        atx.setErrorContext("EC_COMMON_1004", MessageService.getMessage("EC_COMMON_1004"), "【工位设备停机月表】", ex);
    }
    ...
    protected int performExecute(ActionContext atx) throws Exception {
        ...
        String fileName = "工位设备停机月报表";
        List list = PmcEquipmentStopDao.queryPmcEquipmentStopMonth(con, ppdate,proline,station,equipmentstop,banci,whereSQL);
        List listEq = PmcEquipmentStopDao.queryPmcEquipmentStopMonthEq(con, ppdate,proline,station,equipmentstop,banci,whereSQL);
