...
(function() {
  ...
  //停线原因分类
    var classdata = [["设备故障","默认设备故障"],["线首缺车","线首缺车"],["堵线","堵线"],["模修","模修"],["TryOut","TryOut"],["Standby","Standby"],["人工停线","人工停线"],["急停","急停"]];
...
//                	return ht.pub.getValueExactByKey(sectionStore, 'VALUE', value, 'TEXT');
//                },
                editor : {
                    xtype : 'combo',
	                name : 'EventData46',
            ...
            deletedKeyFields : ['ID'],
            addBtn : {
                action : 'CYCJ_ADD_STOPLINE_ACTION',
                outputTable : 'TAB_STOP_LINE',
                position : 2
            },
            updateBtn : {
            ...
            deleteBtn : {
                action : 'CYCJ_DELETE_STOPLINE_ACTION',
                position : 4
            },
            ctTopbarComponts : [{ 
                iconCls : 'excel',
