...
(function() {
    ...
    var stopLinePanel = new ht.base.RowEditorPanel({
        ...
        queryFormConfig : {
            ...
            action : 'CYCJ_QUERY_PMC_VIEW_RECORD_ACTION',
        ...
        gridConfig : {
            ...
            //增加按钮
	        addBtn : {
	            action : 'CYCJ_ADD_PMC_VIEW_RECORD_ACTION',
	        ...
	        //修改按钮
	        updateBtn : {
	            action : 'CYCJ_UPDATE_PMC_VIEW_RECORD_ACTION',
	            outputTable : '', //数据返回的output
	            tagValue : '',
	            position : 2
	        },
	        ...
	        //删除按钮
	        deleteBtn : {
	            action : 'CYCJ_DELETE_PMC_VIEW_RECORD_ACTION',
	            tagValue : '',
	            position : 3
	        },
            ctTopbarComponts : [{ 
