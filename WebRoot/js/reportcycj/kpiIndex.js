  ...
  //新增班次信息
    ...
    var equStopLinePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'CYCJ_QUERY_PMC_PP_KPIDAY_ACTION',
        ...
        gridConfig : {
            ...
            storeFields : ['ID','PPDATE','PRODUCTIONLINE','PRODUCTIONLINENAME','BANCI','MTTR','MTBF','EQMRATE','EQPSTOP','STOPTIME','STOPCOUNT'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
                text : '导出',
    ...
    var exportFn = function(){
        var url = 'json?action=CYCJ_EXPORT_PMC_PP_KPIDAY_ACTION';
...
//                title : '时间'
    ...
    var monthEquStopLinePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'CYCJ_QUERY_PMC_PP_KPIMONTH_ACTION',
    ...
    var exportFn1 = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_PMC_PP_KPIMONTH_ACTION';
...
//                title : '时间'
    ...
    var yearEquStopLinePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'CYCJ_QUERY_PMC_PP_KPIYEAR_ACTION',
    ...
    var exportFn2 = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_PMC_PP_KPIYEAR_ACTION';
