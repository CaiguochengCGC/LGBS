...
//					value : new Date(new Date().getTime() - 4 * 24 * 60 * 60 * 1000),
					value : new Date(new Date().getTime() - (1 * 24 * 60 * 60 * 1000+((new Date().getHours()-8)* 60 * 60 * 1000 + new Date().getMinutes()* 60 * 1000 + new Date().getSeconds()* 1000))),
            ...
            action : 'CYCJ_QUERY_PP_ALARM_LOG_ACTION',
        ...
        gridConfig : {
            ...
            storeFields : ['ID','PRODUCTION','PRODUCTIONNAME','BANCI','STOPSTARTTIME','STOPENDTIME','STOPTIME','STOPRESON',
            				'ALARMSTARTTIME','ALARMENDTIME','ALARMTIME','ALARMMSG','EQUIPMENT','ATTRBUTE'],
            				updateBtn : {
            	                action : 'CYCJ_SAVE_ALARM_EVENT_ACTION',
            	                tagValue : ''
            	            },
            ctTopbarComponts : [{ 
                iconCls : 'excel',
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_PP_ALARM_LOG_ACTION';
