  ...
  //新增班次信息
    ...
    var equStopLinePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            enableQueryButton : true,
            action : 'CYCJ_QUERY_PMC_EQUIPMENT_STOPLINE_ACTION',
        ...
        gridConfig : {
            ...
            isPageAction : false,
            isMultipleSelect : false,
            storeFields : ['ID','PPDATE','FACTORY','WORKSHOP','PRODUCTIONLINENAME','BANCI','BEIZHU', 'FPRODUCTIONLINE','PRODUCTIONLINE','STOPCOUNT',
                            'STOPTIME','STOPCOUNT','DATA3','DATA4','DATA5','DATA6','DATA7'],
            deletedKeyFields : ['ID'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
                text : '导出',
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_ASPM_SPEED';
        ...
        items: {
            ...
            tipRenderer : function(chart, record, i, series){
                return '工段：' + record.get(chart.categoryField) + '\n'  + 
                        '换模时间: ' + record.get(chart.dataField) + '秒\n'; +
    ...
    var weekEquStopLinePanel = new ht.base.PlainPanel({
        ...
        gridConfig : {
            ...
            isMultipleSelect : false,
            storeFields : ['ID','PPDATE','FACTORY','WORKSHOP', 'PRODUCTIONLINENAME','BANCI','BEIZHU','FPRODUCTIONLINE','PRODUCTIONLINE','STOPCOUNT',
                            'STOPTIME','STOPCOUNT','DATA3','DATA3','DATA4','DATA5','DATA6','DATA7'],
            deletedKeyFields : ['ID'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
                text : '导出',
    ...
    var weekexportFn = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_ASPM_SPEED_WEEK_ACTION';
    ...
    var monthEquStopLinePanel = new ht.base.PlainPanel({
        ...
        gridConfig : {
            ...
            storeFields : ['ID','PPDATE','FACTORY','WORKSHOP','BANCI','BEIZHU', 'FPRODUCTIONLINE','PRODUCTIONLINENAME','PRODUCTIONLINE','STOPCOUNT',
                            'STOPTIME','STOPCOUNT','DATA3','DATA3','DATA4','DATA5','DATA6','DATA7'],
            deletedKeyFields : ['ID'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
   ...
   //月饼图
    ...
    var monthexportFn = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_ASPM_SPEED_MONTH_ACTION';
    ...
    var yearEquStopLinePanel = new ht.base.PlainPanel({
        ...
        gridConfig : {
            ...
            isPageAction : false,
            isMultipleSelect : false,
            storeFields : ['ID','PPDATE','FACTORY','WORKSHOP', 'FPRODUCTIONLINE','PRODUCTIONLINENAME','BANCI','BEIZHU','PRODUCTIONLINE','STOPCOUNT',
                            'STOPTIME','STOPCOUNT','DATA3','DATA3','DATA4','DATA5','DATA6','DATA7'],
            deletedKeyFields : ['ID'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
   ...
   //年饼图
    ...
    var yearexportFn = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_ASPM_SPEED_YEAR_ACTION';
