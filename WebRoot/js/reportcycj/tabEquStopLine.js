...
(function() {
  ...
  //新增班次信息
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_PMC_EQUIPMENT_STOPLINE_ACTION';
    ...
    var weekexportFn = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_PMC_EQUIPMENT_STOPLINE_WEEK_ACTION';
    ...
    var monthexportFn = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_PMC_EQUIPMENT_STOPLINE_MONTH_ACTION';
    ...
    var yearexportFn = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_PMC_EQUIPMENT_STOPLINE_YEAR_ACTION';
