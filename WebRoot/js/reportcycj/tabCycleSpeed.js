...
(function() {
  ...
  //新增班次信息
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_CYCLE_SPEED';
    ...
    var weekexportFn = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_PMC_CYCLE_SPEED_WEEK_ACTION';
   ...
   //月饼图
    ...
    var monthexportFn = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_PMC_CYCLE_SPEED_MONTH_ACTION';
   ...
   //年饼图
    ...
    var yearexportFn = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_PMC_CYCLE_SPEED_YEAR_ACTION';
