...
(function() {
    ...
    var dayYieldPanel = new ht.base.RowEditorPanel({
        ...
        queryFormConfig : {
            ...
            action : 'CYCJ_QUERY_TAB_PRODUCT_HOUR_ACTION',
...
//            	alert(new Date().getSeconds()* 1000);
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_TAB_PRODUCT_HOUR_ACTION';
    ...
    var weekYieldPanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'CYCJ_QUERY_PMC_PP_WEEK_ACTION',
    ...
    var exportFn1 = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_PMC_PP_WEEK_ACTION';
...
//            params['COLUMN'].push('COLUMN=' + columns[i].dataIndex);
    ...
    var monthYieldPanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'CYCJ_QUERY_PMC_PP_MM_ACTION',
    ...
    var exportFn2 = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_PMC_PP_MM_ACTION';
    ...
    var yearYieldPanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'CYCJ_QUERY_PMC_PP_YY_ACTION',
    ...
    var exportFn3 = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_PMC_PP_YY_ACTION';
