...
(function() {
    ...
    var workTimePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'CYCJ_QUERY_PMC_DATE_IMPORT_IMPORT_ACTION',
        ...
        gridConfig : {
            ...
            deletedKeyFields : ['ID'],
            addBtn : {
                action : 'CYCJ_ADD_PMC_DATE_IMPORT_ACTION',
                outputTable : 'PMC_DATE_IMPORT',
                position : 2
            },
            updateBtn : {
                action : 'CYCJ_UPDATE_PMC_DATE_IMPORT_ACTION',
                position : 3
            },
            deleteBtn : {
                action : 'CYCJ_DELETE_PMC_DATE_IMPORT_ACTION',
                position : 4
            },
            ctTopbarComponts : [{
                ...
                listeners : {
                    fileselected : function(field) {
                        if (!/\.(xls)$/i.test(field.getValue())) {
                            ht.pub.error('必须是扩展名为 xls 的Excel文件');
                            field.reset();
                            return;
                        }
...
//	                    }
            ...
            addPanel : {
                windowTitle : ht.msg.base.addText + '冲压车间计划数量',
                panelDiffHeight : 25,
                autoScroll : false
            },
            updatePanel : {
                windowTitle : ht.msg.base.updateText + '冲压车间计划数量',
                panelDiffHeight : 25,
                autoScroll : false
            }
        },
    ...
    var importFileFn = function(field){
        var params = {};
        params['action'] = 'CYCJ_SAVE_PMC_DATE_IMPORT_ACTION';
        params['FACTORY'] = '上汽';
        params['WORKSHOP'] = '车间';
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_PMC_DATE_IMPORT_ACTION';
