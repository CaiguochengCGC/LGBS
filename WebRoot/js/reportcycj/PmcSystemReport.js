...
(function() {
    ...
    var PmcSystemReportPanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'CYCJ_QUERY_PMC_SYSTEM_REPORT_ACTION',
        ...
        gridConfig : {
            ...
            storeFields : ['ID','PRODUCTIONLINE','PRODUCTIONLINENAME','BANCI','CYCLETIME','BEIZHU','REALTIME','PLANTIME','DDRATE','DATA3','DATA4','DATA5',
            				'DATA6','DATA7','DATA8','DATA9','DATA10','EventDate29','PLANCOUNT','channengwanclv','STOPTIME','STOPCOUNT','RESTTIME'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
                text : '导出',
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=CYCJ_EXPORT_PMC_SYSTEM_REPORT_ACTION';
