...
ht.base.PlainPanel = Ext.extend(Ext.Panel, {
    layout : 'border',
    border : false,
...
//        ht.pub.date.formatDateFields(backpanel.gridConfig.storeFields, backpanel.ht_outputStore);
    ...
    /**
     * 获取正在编辑的PropertyPanel（增加、修改弹窗）
     * @return {ht.base.PropertyPanel}
     */
    getEditPropertyPanel : function() {
        var backpanel = this;
        if (backpanel.ht_outputAddWindow && backpanel.ht_outputAddWindow.isVisible()) {
            return backpanel.ht_outputAddFormPanel.ownerCt;
        }
        
        if (backpanel.ht_outputUpdateWindow && backpanel.ht_outputUpdateWindow.isVisible()) {
            return backpanel.ht_outputUpdateFormPanel.ownerCt;
        }
    },
    
    /**
     * 获取增加编辑的PropertyPanel（增加、修改弹窗）
     * @return {ht.base.PropertyPanel}
     */
    getAddEditPropertyPanel : function() {
        var backpanel = this;
    ...
    /**
     * 获取修改编辑的PropertyPanel（增加、修改弹窗）
     * @return {ht.base.PropertyPanel}
     */
    getUpdateEditPropertyPanel : function() {
        var backpanel = this;
        ...
        var gridParams = {
            ...
            listeners : {
                ...
                afteredit : function(e) {
                	var cycjall='1#冲压线,2#冲压线,3#冲压线,开卷落料线';
                	var yqcjall='电泳,电泳烘房,电泳打磨,UBS,底涂,中涂,中涂烘房,中涂打磨,面漆,面漆烘房,精饰,报交,注蜡,PBS,WBS';
                	var keyword=e.record.data.EventData40.replace(/\s/g,"");
                	var surl;
                	if(yqcjall.indexOf(keyword)!=-1){
                		surl='json?action=YQCJ_UPDATE_STOPLINE_ACTION';
                		surl += '&ID=' + e.record.data.ID;
                		surl += '&EventData54=' + e.record.data.EventData54;
                		surl += '&EventDate1=' + e.record.data.EventDate1;
                		surl += '&EventDate2=' + e.record.data.EventDate2;
                		surl += '&StopReson=' + e.record.data.StopReson;
                		surl += '&BANCI=' + e.record.data.BANCI;
                		surl += '&EventData46=' + e.record.data.EventData46;
                		surl += '&EventData50=' + e.record.data.EventData50;
                		surl += '&EventData51=' + e.record.data.EventData51;
                		surl += '&EventData53=' + e.record.data.EventData53;
                	}else if(cycjall.indexOf(keyword)!=-1){
                		surl='json?action=CYCJ_UPDATE_STOPLINE_ACTION';
                		surl += '&ID=' + e.record.data.ID;
                		surl += '&EventData54=' + e.record.data.EventData54;
                		surl += '&EventDate1=' + e.record.data.EventDate1;
                		surl += '&EventDate2=' + e.record.data.EventDate2;
                		...
                		console.log(yqcjall);
                		console.log(cycjall);
                		console.log(yqcjall.indexOf(keyword));
                		console.log(cycjall.indexOf(keyword));
                		return false;
                	}
    ...
    initAddWindow : function() {
        ...
        var editPanel = new ht.base.PropertyPanel({
            ...
            formConfig : {
                ...
                autoScroll : addPanel.autoScroll
            },
            ...
            ctListeners : {
                ...
                afterSubmit :  function(action){ 
                    ...
                    //获取checkbox的值
                    ht.pub.getCheckboxValues(editPanel.ht_outputFormPanel, editPanel.tempDataFieldNames, formValues);
        ...
        //窗口显示后处理
        backpanel.ht_outputAddWindow.on('show', function(){
        ...
        //窗口隐藏后
        backpanel.ht_outputAddWindow.on('hide', function() {
    ...
    initUpdateWindow : function() {
        ...
        var editPanel = new ht.base.PropertyPanel({
            ...
            formConfig : {
                ...
                autoScroll : updatePanel.autoScroll
            },
        ...
        //窗口显示后处理
        backpanel.ht_outputUpdateWindow.on('show', function(){
        ...
        //窗口隐藏后
        backpanel.ht_outputUpdateWindow.on('hide', function() {
...
//            collapseMode : 'mini',
    ...
    initComponent : function() {
        ...
        ht.base.PlainPanel.superclass.initComponent.call(backpanel);
...
Ext.reg('plainpanel', ht.base.PlainPanel);
