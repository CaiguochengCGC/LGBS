  ...
  //新增班次信息
    ...
    var monthEquStopLinePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'YQCJ_QUERY_PMC_PP_START_RATE_ACTION',
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=YQCJ_EXPORT_PMC_PP_START_RATE_ACTION';
    ...
    var picexportFn = function(){
        ...
        var url = 'json?action=YQCJ_EXPORT_PMC_PP_START_RATE_PIC_MONTH_ACTION';
...
//            labelRenderer : String,
    ...
    var yearEquStopLinePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'YQCJ_QUERY_PMC_PP_START_RATE_Y_ACTION',
    ...
    var exportFn1 = function(){
        ...
        var url = 'json?action=YQCJ_EXPORT_PMC_PP_START_RATE_Y_ACTION';
