...
(function() {
    ...
    var workTimePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'YQCJ_QUERY_PMC_DATE_IMPORT_IMPORT_ACTION',
        ...
        gridConfig : {
            ...
            deletedKeyFields : ['ID'],
            addBtn : {
                action : 'YQCJ_ADD_PMC_DATE_IMPORT_ACTION',
                outputTable : 'PMC_DATE_IMPORT',
                position : 2
            },
            updateBtn : {
                action : 'YQCJ_UPDATE_PMC_DATE_IMPORT_ACTION',
                position : 3
            },
            deleteBtn : {
                action : 'YQCJ_DELETE_PMC_DATE_IMPORT_ACTION',
                position : 4
            },
            ctTopbarComponts : [{
...
//	                    }
    ...
    var importFileFn = function(field){
        var params = {};
        params['action'] = 'YQCJ_SAVE_PMC_DATE_IMPORT_ACTION';
        params['FACTORY'] = '上汽';
        params['WORKSHOP'] = '车间';
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=YQCJ_EXPORT_PMC_DATE_IMPORT_ACTION';
