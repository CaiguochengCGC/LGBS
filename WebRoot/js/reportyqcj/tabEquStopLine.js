...
(function() {
  ...
  //新增班次信息
    ...
    var equStopLinePanel = new ht.base.PlainPanel({
        ...
        gridConfig : {
            ...
            storeFields : ['ID','PPDATE','FACTORY','WORKSHOP','PRODUCTIONLINENAME','BANCI','CYCLETIME', 'FPRODUCTIONLINE','PRODUCTIONLINE','STOPCOUNT',
                            'STOPTIME','STOPCOUNT','DATA3','DATA4','DATA5','DATA6','DATA7','DATA8'],
            deletedKeyFields : ['ID'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
                text : '导出',
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=YQCJ_EXPORT_PMC_EQUIPMENT_STOPLINE_ACTION';
    ...
    var weekEquStopLinePanel = new ht.base.PlainPanel({
        ...
        gridConfig : {
            ...
            isMultipleSelect : false,
            storeFields : ['ID','PPDATE','FACTORY','WORKSHOP', 'PRODUCTIONLINENAME','BANCI','CYCLETIME','FPRODUCTIONLINE','PRODUCTIONLINE','STOPCOUNT',
                            'STOPTIME','STOPCOUNT','DATA3','DATA3','DATA4','DATA5','DATA6','DATA7','DATA8'],
            deletedKeyFields : ['ID'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
                text : '导出',
    ...
    var weekexportFn = function(){
        ...
        var url = 'json?action=YQCJ_EXPORT_PMC_EQUIPMENT_STOPLINE_WEEK_ACTION';
    ...
    var monthexportFn = function(){
        ...
        var url = 'json?action=YQCJ_EXPORT_PMC_EQUIPMENT_STOPLINE_MONTH_ACTION';
    ...
    var yearexportFn = function(){
        ...
        var url = 'json?action=YQCJ_EXPORT_PMC_EQUIPMENT_STOPLINE_YEAR_ACTION';
