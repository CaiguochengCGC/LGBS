  ...
  //新增班次信息
    ...
    var equStopLinePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            enableQueryButton : true,
            action : 'YQCJ_QUERY_PMC_EQUIPMENT_STOPLINE_ACTION',
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=YQCJ_EXPORT_CYCLE_SPEED';
    ...
    var weekexportFn = function(){
        ...
        var url = 'json?action=YQCJ_EXPORT_PMC_CYCLE_SPEED_WEEK_ACTION';
   ...
   //月饼图
    ...
    var monthexportFn = function(){
        ...
        var url = 'json?action=YQCJ_EXPORT_PMC_CYCLE_SPEED_MONTH_ACTION';
   ...
   //年饼图
    ...
    var yearexportFn = function(){
        ...
        var url = 'json?action=YQCJ_EXPORT_PMC_CYCLE_SPEED_YEAR_ACTION';
