...
(function() {
    ...
    var stationStore = new Ext.data.JsonStore({
        ...
        baseParams : {
            action : 'YQCJ_QUERY_TAB_REFER_CT_ACTION',
            CODE_TYPE : 'data7',
            QURY_CODE : ''
        },
        fields : ['VALUE','TEXT']
    ...
    var sectionStore = new Ext.data.JsonStore({
        ...
        root : 'root.PMC_PP_STATION.rs',
        baseParams : {
            action : 'YQCJ_QUERY_PMC_PP_STATION_STOP_ACTION',
...
//					value : new Date(new Date().getTime() - 4 * 24 * 60 * 60 * 1000),
            ...
            action : 'YQCJ_QUERY_PP_ALARM_LOG_ACTION',
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=YQCJ_EXPORT_PP_ALARM_LOG_ACTION';
