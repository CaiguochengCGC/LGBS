  ...
  //新增班次信息
    ...
    var equStopLinePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'YQCJ_QUERY_PMC_PP_KPIDAY_ACTION',
    ...
    var exportFn = function(){
        var url = 'json?action=YQCJ_EXPORT_PMC_PP_KPIDAY_ACTION';
...
//                title : '时间'
    ...
    var monthEquStopLinePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'YQCJ_QUERY_PMC_PP_KPIMONTH_ACTION',
    ...
    var exportFn1 = function(){
        ...
        var url = 'json?action=YQCJ_EXPORT_PMC_PP_KPIMONTH_ACTION';
...
//                title : '时间'
    ...
    var yearEquStopLinePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'YQCJ_QUERY_PMC_PP_KPIYEAR_ACTION',
    ...
    var exportFn2 = function(){
        ...
        var url = 'json?action=YQCJ_EXPORT_PMC_PP_KPIYEAR_ACTION';
