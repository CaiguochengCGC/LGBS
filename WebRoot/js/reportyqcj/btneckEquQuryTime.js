...
(function() {
    ...
    var dayDatePpneckPanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'YQCJ_QUERY_PMC_DATE_PPNECK_FOR_STOPTIME_ACTION',
        ...
        gridConfig : {
           columns : [new Ext.grid.RowNumberer(), {
            ...
            isPageAction : false,
            storeFields : ['DATA4','alarm_message', 'STOPTIME', 'STOPCOUNT'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
                text : '导出',
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=YQCJ_EXPORT_PMC_DATE_PPNECK_FOR_STOPTIME_DAY_ACTION';
