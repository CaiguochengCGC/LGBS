...
(function() {
    ...
    var planDatePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'QUERY_PMC_DATE_IMPORT_ACTION',
        ...
        gridConfig : {
            ...
            storeFields : ['WORKDATE','STARTTIME', 'ENDTIME', 'RESTTIME','LASTTIME','SHIFT','BANCI']
        },
        ctListeners : {
            beforeQuery : function(values){
                equStopLinePanel.ht_outputStore.baseParams['PPDATE'] = values['WORKDATE'];
                equStopLinePanel.ht_outputStore.baseParams['BANCI'] = values['BANCI'];
    ...
    var equStopLinePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'QUERY_PMC_EQUIPMENT_STOPLINE_ACTION',
        ...
        gridConfig : {
            ...
            isPageAction : false,
            isMultipleSelect : false,
            storeFields : ['ID','PPDATE','FACTORY','WORKSHOP','PRODUCTIONLINENAME', 'FPRODUCTIONLINE','PRODUCTIONLINE','STOPCOUNT',
                            'STOPTIME','STOPCOUNT','DATA3','DATA4','DATA5','DATA6','DATA7','BANCI','DATA11'],
            deletedKeyFields : ['ID'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
                text : '导出',
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=EXPORT_PMC_EQUIPMENT_STOPLINE_ACTION';
        var params = {};
        ...
        url += '&queryType=' + equStopLinePanel.ht_outputStore.baseParams['queryType'];
    ...
    var weekexportFn = function(){
        ...
        var url = 'json?action=EXPORT_PMC_EQUIPMENT_STOPLINE_WEEK_ACTION';
        ...
        url += '&queryType=' + weekEquStopLinePanel.ht_outputStore.baseParams['queryType'];
        url += '&' + params['HEADER'].join('&');
        url += '&' + params['COLUMN'].join('&');
        url += '&' + params['WIDTH'].join('&');
    ...
    var monthexportFn = function(){
        ...
        var url = 'json?action=EXPORT_PMC_EQUIPMENT_STOPLINE_MONTH_ACTION';
    ...
    var yearexportFn = function(){
        ...
        var url = 'json?action=EXPORT_PMC_EQUIPMENT_STOPLINE_YEAR_ACTION';
