...
(function() {
    ...
    var workTimePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'QUERY_PMC_DATE_IMPORT_IMPORT_ACTION',
        ...
        gridConfig : {
            ...
            deletedKeyFields : ['ID'],
            addBtn : {
                action : 'ADD_PMC_DATE_IMPORT_ACTION',
                outputTable : 'PMC_DATE_IMPORT',
                position : 2
            },
            updateBtn : {
                action : 'UPDATE_PMC_DATE_IMPORT_ACTION',
                position : 3
            },
            deleteBtn : {
                action : 'DELETE_PMC_DATE_IMPORT_ACTION',
                position : 4
            },
            ctTopbarComponts : [{
...
//                    }
            ...
            addPanel : {
                windowTitle : ht.msg.base.addText + '计划日期数量',
                panelDiffHeight : 25,
                autoScroll : false
            },
            updatePanel : {
                windowTitle : ht.msg.base.updateText + '计划日期数量',
                panelDiffHeight : 25,
                autoScroll : false
            }
        },
