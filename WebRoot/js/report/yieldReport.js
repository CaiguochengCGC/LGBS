...
(function () {
    ...
    var carTypeStore = new Ext.data.JsonStore({
        ...
        baseParams: {
            action: 'QUERY_PMC_CAR_TYPE_ACTION',
            CODE_TYPE: 'CAR_TYPE_NAME'
        },
        fields: ['VALUE', 'TEXT']
    });
    //获得工段注释
    ...
    carTypeStore.load({
        callback: function () {
            ht.pub.store.addBlankText(carTypeStore);
        }
    });
    //产量日报表
    var dayYieldPanel = new ht.base.PlainPanel({
        ...
        queryFormConfig: {
            ...
            items: [{
            ...
            },
                {
                    ...
                    listeners : {
                        select : function(c){
                            beatDailyReportPanel.findQueryCompment('CARNAME').setValue(null);
                        }
                    }*/
                }, {
                    xtype: 'combo',
        ...
        gridConfig: {
            storeFields: this.outputTable,
            isLocalPageAction: false,
            columns: [
            ...
            storeFields: ['EventData', 'EventDate1', 'EventDate3', 'EventDate4', 'EventDate5', 'EventDate6', 'EventDate7', 'EventDate8', 'EventDate9', 'EventDate10', 'EventDate11', 'EventDate12',
                ...
                , 'EventDate25', 'EventDate26', 'EventDate27', 'EventDate28', 'EventDate29', 'EventDate30', 'EventDate31', 'EventDate32', 'carType'],
            ctTopbarComponts: [{
                iconCls: 'excel',
                text: '导出',
    ...
    var exportFn = function () {
        ...
        var url = 'json?action=EXPORT_TAB_PRODUCT_HOUR_ACTION';
        ...
        var columns
            = dayYieldPanel.gridConfig.columns;
    ...
    var weekYieldPanel = new ht.base.PlainPanel({
        ...
        queryFormConfig: {
            ...
            action: 'QUERY_PMC_PP_WEEK_ACTION',
        ...
        gridConfig: {
            ...
            isPageAction: false,
            storeFields: ['PRODUCTIONLINE', 'PRODUCTIONLINENAME', 'DATA1', 'DATA2', 'DATA3', 'DATA4', 'DATA5', 'DATA6', 'DATA7', 'DATA8', 'DATA9'
                ...
                , 'DATA46', 'DATA47', 'DATA48', 'DATA49', 'DATA50', 'DATA51', 'DATA52', 'YYPLANP', 'YYREALP', 'WEEKRATE', 'SHIFT', 'carType'],
            ctTopbarComponts: [{
                iconCls: 'excel',
                text: '导出',
                enableByRowSelected: false,
    ...
    var exportFn1 = function () {
        ...
        var url = 'json?action=EXPORT_PMC_PP_WEEK_ACTION';
    ...
    var monthYieldPanel = new ht.base.PlainPanel({
        ...
        gridConfig: {
            ...
            isPageAction: false,
            isMultipleSelect: false,
            storeFields: ['YYYY_MM', 'PRODUCTIONLINE', 'PRODUCTIONLINENAME', 'DATA1', 'DATA2', 'DATA3', 'DATA4', 'DATA5', 'DATA6', 'DATA7', 'DATA8'
                , 'DATA9', 'DATA10', 'DATA11', 'DATA12', 'DATA13', 'DATA14', 'DATA15', 'DATA16', 'DATA17', 'DATA18', 'DATA19', 'DATA20', 'DATA21'
                , 'DATA22', 'DATA23', 'DATA24', 'DATA25', 'DATA26', 'DATA27', 'DATA28', 'DATA29', 'DATA30', 'DATA31', 'MMPLANP', 'MMREALP', 'MMRATE', 'BANCII', 'carType'],
            ctTopbarComponts: [{
                iconCls: 'excel',
                text: '导出',
                enableByRowSelected: false,
    ...
    var exportFn2 = function () {
        ...
        var url = 'json?action=EXPORT_PMC_PP_MM_ACTION';
    ...
    var yearYieldPanel = new ht.base.PlainPanel({
        ...
        gridConfig: {
            ...
            isPageAction: false,
            isMultipleSelect: false,
            storeFields: ['YYYY', 'PRODUCTIONLINE', 'PRODUCTIONLINENAME', 'DATA1', 'DATA2', 'DATA3', 'DATA4', 'DATA5', 'DATA6', 'DATA7', 'DATA8'
                , 'DATA9', 'DATA10', 'DATA11', 'DATA12', 'YYPLANP', 'YYREALP', 'YYRATE', 'SHIFTT', 'carType'],
            ctTopbarComponts: [{
                iconCls: 'excel',
                text: '导出',
                enableByRowSelected: false,
    ...
    var exportFn3 = function () {
        ...
        var url = 'json?action=EXPORT_PMC_PP_YY_ACTION';
