...
(function() {
    ...
    var equStopLinePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'QUERY_PMC_PP_KPIDAY_ACTION',
        ...
        gridConfig : {
            ...
            storeFields : ['ID','PPDATE','PRODUCTIONLINE','PRODUCTIONLINENAME','MTTR','MTBF','EQMRATE','EQPSTOP','STOPTIME','STOPCOUNT','SHIFT','FORMAT_PRODUCTLINE'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
                text : '导出',
    ...
    var exportFn = function(){
        var url = 'json?action=EXPORT_PMC_PP_KPIDAY_ACTION';
    ...
    var monthEquStopLinePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'QUERY_PMC_PP_KPIMONTH_ACTION',
        ...
        gridConfig : {
            ...
            isPageAction : false,
            isMultipleSelect : false,
            storeFields : ['ID','YYYY_MM','PRODUCTIONLINE','PRODUCTIONLINENAME','MTTR','MTBF','EQMRATE','EQPSTOP','STOPTIME','STOPCOUNT','SHIFT','FORMAT_PRODUCTLINE'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
                text : '导出',
                enableByRowSelected : false,
    ...
    var exportFn1 = function(){
        ...
        var url = 'json?action=EXPORT_PMC_PP_KPIMONTH_ACTION';
    ...
    var yearEquStopLinePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'QUERY_PMC_PP_KPIYEAR_ACTION',
        ...
        gridConfig : {
            ...
            isPageAction : false,
            isMultipleSelect : false,
            storeFields : ['ID','YYYY','PRODUCTIONLINE','PRODUCTIONLINENAME','MTTR','MTBF','EQMRATE','EQPSTOP','STOPTIME','STOPCOUNT','SHIFT','FORMAT_PRODUCTLINE'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
                text : '导出',
                enableByRowSelected : false,
    ...
    var exportFn2 = function(){
        ...
        var url = 'json?action=EXPORT_PMC_PP_KPIYEAR_ACTION';
