...
(function() {
    ...
    var dayDatePpneckPanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'QUERY_PMC_DATE_PPNECK_FOR_STOPTIME_ACTION',
        ...
        gridConfig : {
           columns : [new Ext.grid.RowNumberer(), {
            ...
            isPageAction : false,
            storeFields : ['EventData7','EventData4','EventData5', 'STOPTIME', 'STOPCOUNT','BANCI'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
                text : '导出',
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=EXPORT_PMC_DATE_PPNECK_FOR_STOPTIME_DAY_ACTION';
        ...
        url += '&BANCI=' + dayDatePpneckPanel.ht_outputStore.baseParams['BANCI'];
    ...
    var weekexportFn = function(){
        ...
        url += '&BANCI=' + weekDatePpneckPanel.ht_outputStore.baseParams['BANCI'];
    ...
    var monthexportFn = function(){
        ...
        url += '&BANCI=' + monthDatePpneckPanel.ht_outputStore.baseParams['BANCI'];
    ...
    var yearexportFn = function(){
        ...
        url += '&BANCI=' + yearDatePpneckPanel.ht_outputStore.baseParams['BANCI'];
    ...
    var backPanel =new Ext.TabPanel({
        ...
        items : [{
            ...
            border : false,
            layout : 'border',
            items : [dayDatePpneckPanel,exportPanel]
        },{
            title : '周报表',
            border : false,
            layout : 'border',
