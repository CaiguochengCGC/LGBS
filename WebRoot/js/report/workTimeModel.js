...
(function() {
    ...
    //获取所有生产线
    var lineStoreEn = new Ext.data.JsonStore({
        url : 'json',
        root : 'root.PMC_PP_LINE_EN.rs',
        baseParams : {
            action : 'QUERY_PMC_LINEEN_DATE'
        },
        fields : ['VALUE','TEXT']
    });
    lineStoreEn.load({
        callback : function() {
            ht.pub.store.addBlankText(lineStoreEn);
        }
    });
