...
(function() {
    ...
    var dayDatePpneckPanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'ZZCJ_QUERY_PMC_DATE_PPNECK_FOR_STOPTIME_ACTION',
        ...
        gridConfig : {
           columns : [new Ext.grid.RowNumberer(), {
            ...
            isPageAction : false,
            storeFields : ['DATA1','ALARM_MESSAGE', 'STOPTIME', 'STOPCOUNT'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
                text : '导出',
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=ZZCJ_EXPORT_PMC_DATE_PPNECK_FOR_STOPTIME_DAY_ACTION';
...
//        var url = 'json?action=EXPORT_PMC_DATE_PPNECK_FOR_STOPTIME_WEEK_ACTION';
        var url = 'json?action=ZZCJ_EXPORT_PMC_DATE_PPNECK_FOR_STOPTIME_DAY_ACTION';
...
//        var url = 'json?action=EXPORT_PMC_DATE_PPNECK_FOR_STOPTIME_MONTH_ACTION';
        var url = 'json?action=ZZCJ_EXPORT_PMC_DATE_PPNECK_FOR_STOPTIME_DAY_ACTION';
...
//        var url = 'json?action=EXPORT_PMC_DATE_PPNECK_FOR_STOPTIME_YEAR_ACTION';
        var url = 'json?action=ZZCJ_EXPORT_PMC_DATE_PPNECK_FOR_STOPTIME_DAY_ACTION';
