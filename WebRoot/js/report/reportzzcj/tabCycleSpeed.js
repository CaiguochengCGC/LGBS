...
(function() {
  ...
  //新增班次信息
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=ZZCJ_EXPORT_CYCLE_SPEED';
        ...
        items: {
            ...
            tipRenderer : function(chart, record, i, series){
                ...
                return '工段：' + record.get(chart.categoryField) + '\n'  + 
                        '工段时间: ' + record.get(chart.dataField) + '秒\n'; +
    ...
    var weekexportFn = function(){
        ...
        var url = 'json?action=ZZCJ_EXPORT_PMC_CYCLE_SPEED_WEEK_ACTION';
   ...
   //月饼图
    ...
    var monthexportFn = function(){
        ...
        var url = 'json?action=ZZCJ_EXPORT_PMC_CYCLE_SPEED_MONTH_ACTION';
    ...
    var yearEquStopLinePanel = new ht.base.PlainPanel({
        ...
        gridConfig : {
            ...
            storeFields : ['ID','PPDATE','FACTORY','WORKSHOP', 'FPRODUCTIONLINE','PRODUCTIONLINENAME','BANCI','CYCLETIME','PRODUCTIONLINE','STOPCOUNT',
                            'STOPTIME','STOPCOUNT','DATA3','DATA3','DATA4','DATA5','DATA6','DATA7','FORMAT_PRODUCTLINE'],
            deletedKeyFields : ['ID'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
                text : '导出',
   ...
   //年饼图
    var yearPiePanel = new Ext.Panel({
        ...
        items: {
            ...
            xtype: 'piechart',
            dataField: 'CYCLETIME',
            categoryField: 'FORMAT_PRODUCTLINE',
            extraStyle : {
                legend : {
                    display: 'right',
                    padding : 5,
    ...
    var yearexportFn = function(){
        ...
        var url = 'json?action=ZZCJ_EXPORT_PMC_CYCLE_SPEED_YEAR_ACTION';
