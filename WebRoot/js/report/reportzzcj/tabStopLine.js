...
(function() {
    ...
    var weekStore = new Ext.data.JsonStore({
        ...
        root : 'root.PUB_DATA_DICT.rs',
        baseParams : {
            action : 'ZZCJ_GET_CODE_VALUE_ACTION',
            CODE_TYPE : 'WEEK'
        },
        fields : ['VALUE','TEXT']
    });
    ...
    var sectionStore = new Ext.data.JsonStore({
        ...
        baseParams : {
            action : 'ZZCJ_QUERY_PMC_PP_STATION_ALL_ACTION',
    ...
    var stationStore = new Ext.data.JsonStore({
        ...
        root : "root.PMC_PP_STATION.rs",
        baseParams : {
            action : 'ZZCJ_QUERY_TAB_STOP_STA_ALL_ACTION',
    ...
    var equipmentStopStore = new Ext.data.JsonStore({
        ...
        root : "root.PMC_PP_STATION.rs",
        baseParams : {
            action : 'ZZCJ_QUERY_PMC_PP_STATION_EQUIPMENT_ACTION'
        },
        fields : ['VALUE','TEXT']
    });
...
/*            new Ext.grid.RowNumberer(),{
    ...
    var stopLinePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'ZZCJ_QUERY_PMC_EQUIPMENT_STOP_ACTION',
