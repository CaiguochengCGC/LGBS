...
(function() {
    ...
    var dayYieldPanel = new ht.base.RowEditorPanel({
        ...
        queryFormConfig : {
            ...
            action : 'ZZCJ_QUERY_TAB_PRODUCT_HOUR_ACTION',
...
//            outputTable : 'TAB_PRODUCT_HOUR'
        ...
        gridConfig : {
            ...
            storeFields : ['ID','EventData','EventDate1','EventDate3','BANCI', 'EventDate4', 'EventDate5','EventDate6','EventDate7','EventDate8','EventDate9','EventDate10','EventDate11','EventDate12',
                        ...
                        ,'EventDate25','EventDate26','EventDate27','EventDate28','EventDate29','EventDate30','EventDate31','EventDate32','PLANDATA','RATE','FORMAT_PRODUCTIONLINE'],
            updateBtn : {
...
//            	alert(new Date().getSeconds()* 1000);
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=ZZCJ_EXPORT_TAB_PRODUCT_HOUR_ACTION';
    ...
    var weekYieldPanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'ZZCJ_QUERY_PMC_PP_WEEK_ACTION',
        ...
        gridConfig : {
            ...
            , 'DATA46', 'DATA47', 'DATA48', 'DATA49', 'DATA50', 'DATA51', 'DATA52','YYPLANP','YYREALP','WEEKRATE','FORMAT_PRODUCTIONLINE'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
                text : '导出',
                enableByRowSelected : false,
    ...
    var exportFn1 = function(){
        ...
        var url = 'json?action=ZZCJ_EXPORT_PMC_PP_WEEK_ACTION';
...
//            params['COLUMN'].push('COLUMN=' + columns[i].dataIndex);
    ...
    var monthYieldPanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'ZZCJ_QUERY_PMC_PP_MM_ACTION',
    ...
    var exportFn2 = function(){
        ...
        var url = 'json?action=ZZCJ_EXPORT_PMC_PP_MM_ACTION';
    ...
    var yearYieldPanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'ZZCJ_QUERY_PMC_PP_YY_ACTION',
    ...
    var exportFn3 = function(){
        ...
        var url = 'json?action=ZZCJ_EXPORT_PMC_PP_YY_ACTION';
