  ...
  //新增班次信息
    ...
    var monthEquStopLinePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'ZZCJ_QUERY_PMC_PP_START_RATE_ACTION',
        ...
        gridConfig : {
            ...
            storeFields : ['ID','PRODUCTIONLINE','PRODUCTIONLINENAME','BANCI','DATA1','DATA2','DATA3','DATA4','DATA5',
            				...
            				,'DATA28','DATA29','DATA30','DATA31','MMRATE','MMSTOPTIMEE','MMREALP','MMPLANP','FORMAT_PRODUCTIONLINE'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
                text : '导出',
    ...
    var exportFn = function(){
        ...
        var url = 'json?action=ZZCJ_EXPORT_PMC_PP_START_RATE_ACTION';
    ...
    var picexportFn = function(){
        ...
        var url = 'json?action=ZZCJ_EXPORT_PMC_PP_START_RATE_PIC_MONTH_ACTION';
...
//            labelRenderer : String,
    ...
    var yearEquStopLinePanel = new ht.base.PlainPanel({
        ...
        queryFormConfig : {
            ...
            action : 'ZZCJ_QUERY_PMC_PP_START_RATE_Y_ACTION',
        ...
        gridConfig : {
            ...
            storeFields : ['PRODUCTIONLINE','PRODUCTIONLINENAME','BANCI','DATA1','DATA2','DATA3','DATA4','DATA5',
            				'DATA6','DATA7','DATA8','DATA9','DATA10','DATA11','DATA12',
            				'YYRATE','YYSTOPTIMEE','YYREALP','YYPLANP','FORMAT_PRODUCTIONLINE'],
            ctTopbarComponts : [{ 
                iconCls : 'excel',
                text : '导出',
                enableByRowSelected : false,
    ...
    var exportFn1 = function(){
        ...
        var url = 'json?action=ZZCJ_EXPORT_PMC_PP_START_RATE_Y_ACTION';
